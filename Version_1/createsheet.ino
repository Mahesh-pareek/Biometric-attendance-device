...
#define USER_EMAIL "maheshpareek2005@gmail.com"
...
void loop() {
  ...
  if (ready && !taskComplete) {
    ...
    spreadsheet.set("sheets/properties/gridProperties/columnCount", 8);
    ...
    if (success) {
      ...
      valueRange.set("values/[0]/[1]", "Employee Name");
      valueRange.set("values/[0]/[2]", "In Date");
      valueRange.set("values/[0]/[3]", "In Time");
      valueRange.set("values/[0]/[4]", "Out Date");
      valueRange.set("values/[0]/[5]", "Out Time");
      valueRange.set("values/[0]/[6]", "Hours Worked");


      // For Google Sheet API ref doc, go to https://developers.google.com/sheets/api/reference/rest/v4/spreadsheets.values/update

      success = GSheet.values.update(&response, sheetId, "EntriesLog!A1:G1", &valueRange);
